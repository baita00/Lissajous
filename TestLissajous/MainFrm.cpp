...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext) 
{
	...
	m_wndSplitter.CreateView(0, 0, RUNTIME_CLASS(CCmdFormView), CSize(0,0), pContext);
	m_wndSplitter.CreateView(0, 1, RUNTIME_CLASS(CTestLissajousView), CSize(0,0), pContext);
